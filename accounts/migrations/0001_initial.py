...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_profile', (
            ...
            ('user_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True)),
            ...
            ('location', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
